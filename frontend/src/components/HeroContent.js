...
const HeroContent = () => {
  return (
    <div className="hero h-auto bg-gradient-to-r from-base-300 to-transparent shadow-lg flex items-center justify-center">
      <div className="hero-content text-neutral-content text-center flex flex-col lg:flex-row lg:justify-between lg:items-center lg:text-left w-full max-w-screen-lg px-4 py-8">
